# JRStock 
[Notion](https://expensive-treatment-cae.notion.site/README-f6fa4bf0cb8e4ec29a0109401db87619)
주식 초보자를 위한 국내 주식 백테스팅 서비스  

![Untitled](README_assets/image-20220522181238992.png)

## 목차
### 1. [Introduction](#introduction)
### 2. [Main Function](#main-functions)
### 3. [Development Environment](#%EF%B8%8Fdevelopment-environment)
### 4. [ETC](#service-architecture)

## 💡Motivations

---

 최근 들어 주식에 대한 관심이 급증했으며 작년 동안 유입된 신규 투자자만 400만명에 다다릅니다.그리고 이들은 주식에 대한 지식과 경험이 부족했고, 대부분 투자를 실패했습니다.

이는 안정적인 주식 투자를 위한 러닝 커브는 높고, 이를 학습할 플랫폼은 부족하기 때문입니다.

 그래서 저희는 주식에 입문하며, 주식에 대해 잘 모르는 소액 투자자들 일명 개미, 주린이들이 안전하고 효과적으로 주식 투자를 공부할 수 있도록 매매 전략을 학습하고, 직접 구성한 전략을 테스트할 수 있는 서비스를 개발했습니다.

## 💸Introduction

---

**내 집 마련을 위해 주식은 선택이 아닌 필수!!
남들 다하니까 시작했다가, 손해만 보고 그만 두신 적 없으신가요?!
1000만 개미들의 염원이 담겨 탄생한 바로 그 서비스!!  
굶주린 주식 어린이를 위한 플랫폼 JRStock 과 함께 주식 투자 전문가로 성장해보세요!**

🔹**JRStock**은 국내 주식 기반 백테스트 플랫폼입니다. **JRStock**은 주린이를 대상으로 서비스를 구성하여 누구나 쉽게 매매 전략을 구성하고, 테스트해볼 수 있으며, 결과를 분석할 수 있습니다. 또한 종목 토론방을 통해 지식을 공유하거나, 랭킹을 통해 다른 사람과  전략을 경쟁, 공유하며 성공적인 주식투자로 이끌 수 있습니다.
...
![Untitled](README/Untitled%201.gif)
...
주가 예측 서비스는 이전 주가 데이터를 통해 다음 주가를 예측하여 제공하는 서비스입니다. 
주가 예측 서비스에는 딥러닝 기술 RNN이 적용 됐습니다.
기존 신경망 알고리즘은 데이터 맥락을 학습시킬 수 없었기 때문에 순환 신경망 알고리즘을 사용하게 됐습니다. 아래 예시에서 주가 추세를 상당히 정확하게 예측하고 있습니다.
...
![JRStock.png](README_assets/JRStock.png)

[https://www.erdcloud.com/d/nuiwwuHT3GzMbzrHJ](https://www.erdcloud.com/d/nuiwwuHT3GzMbzrHJ)
